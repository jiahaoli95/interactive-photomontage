...
# def poisson_edit_from_path(source, target, mask, offset=(0,0)):    
...
#     pass
#     scr_dir = '../../../../../Downloads/poisson-image-editing-master/figs/example1'
#     out_dir = scr_dir
#     res = poisson_edit_from_path(path.join(scr_dir, "source1.jpg"), path.join(scr_dir, "target1.jpg"), path.join(scr_dir, "mask1.png"), (0, 66))
